...
### 1.7 [x] 离线评测：检索质量冻结集【已完成 · 2026-08-07 / b13b499 / 4a17f43 / docs/evidence/rag-retrieval-2026-08-07.md（recall@1 0.0714 / precision@1 0.9286 / MRR 0.9464 / top-1 0.9286；反馈闭环数字随数据目录复算，见报告）】
...
### 1.8 [ ] 提效验证：真人对照（assisted vs assisted+RAG）【待实测 · 2026-08-07 / a31ac09 / docs/evidence/stage-6-human-trial-2026-08-07.md；无真人操作员，不虚构比例】
...
### 1.9 [x] 真实模型验证 + README/面试叙事更新【已完成 · 2026-08-07 / a5957f7 / c5c1bf2 / docs/evidence/stage-6-real-model-2026-08-07.md（run 09528bf7：比价页 5 条参考、2 回合、$0.0051、预算内；审批门如实记录）】
